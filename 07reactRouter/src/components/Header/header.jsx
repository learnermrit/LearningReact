...
//Link : we use instead of anchor tag as <a></a> refershes the whole page
//       and there is no concept of page refresh in React
// Link, NavLink both component are used for Navigation
